...
const WalletModal: React.FC<WalletModalProps> = ({ onClose }) => (
  <ModalOverlay>
    <ModalContent>
      <ModalTitle
        style={{ textAlign: "left", fontSize: "16px", fontWeight: "500" }}
      >
        Connect Wallet
      </ModalTitle>
      <ModalText
      ...
      <ModalText style={{ fontWeight: "800" }}>
        Have you installed KasWare?
      </ModalText>
      <InstallLink
      ...
      >
        Install KasWare{" "}
        <LaunchRoundedIcon style={{ fontSize: "12px", paddingTop: "2px" }} />
      </InstallLink>
      <SubText style={{ textAlign: "left", fontWeight: "900" }}>
        On mobile:
      </SubText>
      <ModalText>
